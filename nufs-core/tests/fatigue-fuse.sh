...
# 全量挂载写入做字节精确巡检。
#
# 与 tests/fatigue-test.sh（S3 API 路径）互补：本脚本走"真实挂载访问"
...
#
# 用法:
#   ./tests/fatigue-fuse.sh --duration 600 [--rounds N] [--crash-after 120]
...
# Auto-generated by tests/fatigue-fuse.sh — publishes the multidisk V2.1
